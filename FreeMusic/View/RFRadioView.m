...
//    [audioPlayer play:[NSURL URLWithString:self.selectedPlaylistItem.url]];
    [audioController playFromURL:self.selectedPlaylistItem.url];
...
//    [audioPlayer seekToTime:progress.value];
    ...
    NSLog(@"Slider Changed: %f", progress.value);
//    [audioController seekToTime:progress.value];
}
...
//              || audioPlayer.state == AudioPlayerStateRunning
//              || audioPlayer.state == AudioPlayerStatePlaying) {
//        isPlaying = YES;
//
//    }
