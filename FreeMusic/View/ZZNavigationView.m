...
@synthesize navigationBackColor = _navigationBackColor;
...
//    [leftBtn setImage:leftImage forState:UIControlStateNormal];
    leftBtn.frame = CGRectMake(8, navigationBack.frame.size.height/2 - leftImage.size.height/2-5, leftImage.size.width+20, leftImage.size.height+10);
    [leftBtn setImage:leftImage forState:UIControlStateNormal];
}
...
-(void)setNavigationBackColor:(UIColor *)navigaionBackColor
{
